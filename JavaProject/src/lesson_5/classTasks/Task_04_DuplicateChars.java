...
public class Task_04_DuplicateChars {
...
//        collection.forEach((letter, number) -> System.out.println(letter + " - " + number));
        collection.forEach((letter, number) -> System.out.println(letter));
        collection.forEach((letter, number) -> System.out.println(number));
